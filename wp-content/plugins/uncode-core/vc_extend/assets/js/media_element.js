(function($) {
	var media = wp.media,
		...
		addButton,
		workflows = {};
	var names = new Array('Images', 'Audio', 'Video', 'Vimeo', 'Youtube', 'Soundcloud', 'Spotify', 'Flickr', 'Instagram', 'SVG', 'HTML', 'iFrame');
	var slugs = new Array('image', 'audio', 'video', 'oembed/vimeo', 'oembed/youtube', 'oembed/soundcloud', 'oembed/spotify', 'oembed/flickr', 'oembed/instagram', 'oembed/svg', 'oembed/html', 'oembed/iframe');
